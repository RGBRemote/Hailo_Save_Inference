# Replacing the gstreamer_app.py code with following can save images from real-time inferencing
...
# Modify the app_callback_class to add frame saving functionality
class app_callback_class:
    ...
    def save_frame_with_detections(self, frame, detections_data):
        ...
        if self.should_save_frame(current_time):
